...
/// </summary>
tableextension 50000 "Document Attachment Ext.Stor." extends "Document Attachment"
{
    fields
    {
        field(50000; "Stored Externally"; Boolean)
        {
        ...
        field(50001; "External Upload Date"; DateTime)
        {
        ...
        field(50002; "External File Path"; Text[2048])
        {
        ...
        field(50003; "Stored Internally"; Boolean)
        {
        ...
        field(50004; "Source Environment Hash"; Text[32])
        {
        ...
        field(50005; "Skip Delete On Copy"; Boolean)
        {
